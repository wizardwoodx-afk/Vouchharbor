# Vouch Harbor 18.7.0 — the accountable agent OS (govern · execute · verify · learn)
...
## The VH-19 Generalist — the one front door (18.7.0)
...
**18.7.0 adds the differentiator: cross-user Team-Evolve.** Two users' VH
...
[VH-18.7-UPGRADE.md](VH-18.7-UPGRADE.md) · [VH-18.0-UPGRADE.md](VH-18.0-UPGRADE.md).
