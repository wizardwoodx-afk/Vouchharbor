# Vouch Harbor 18.1.0 — the accountable agent OS (govern · execute · verify · learn)
...
## The VH-19 Generalist — the one front door (18.1.0)

The app opens on the VH-19 door: the user talks to ONE agent. Behind it: a
Mixture-of-Experts-style **specialist bench** (102 real specialists across 10
...
**18.1.0 adds the differentiator: cross-user Team-Evolve.** Two users' VH
...
[VH-18.1-UPGRADE.md](VH-18.1-UPGRADE.md) · [VH-18.0-UPGRADE.md](VH-18.0-UPGRADE.md).
...
node verify/run.mjs   # 109 bundles
...
probe/       110 probe suites, run by `npm test`
