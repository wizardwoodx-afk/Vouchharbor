# Vouch Harbor 18.4.0 "Zenith" — feature sheet
...
## F. Signed collaboration, self-evolution & the Horizon UI (18.2.0; hardened in 18.4.0)
...
Every manifest agrees on **18.4.0 "Zenith"**: `src/version.ts`,
