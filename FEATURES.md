# Vouch Harbor 18.6.0 "Polaris" — feature sheet
...
## F. Signed collaboration, self-evolution & the Horizon UI (18.2.0; hardened in 18.6.0)
...
Every manifest agrees on **18.6.0 "Polaris"**: `src/version.ts`,
