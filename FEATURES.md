# Vouch Harbor 18.5.0 "Apex" — feature sheet
...
## F. Signed collaboration, self-evolution & the Horizon UI (18.2.0; hardened in 18.5.0)
...
Every manifest agrees on **18.5.0 "Apex"**: `src/version.ts`,
