...
var scripted = (answer) => (async () => new Response(JSON.stringify({ choices: [{ message: { content: answer } }] }), { status: 200 }));
test("live-data GuardRail \u2014 runtime enforcement, not a prompt ask", async () => {
  ...
  check("non-research/analysis answers are left alone", code.liveData === void 0 && !code.reply.includes("LIVE-DATA CHECK"));
