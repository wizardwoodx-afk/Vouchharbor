...
| Workflows | Typed design surface for what the engine runs |
...
| System | Connectors, providers, Drill (self-verification), Meta loop (self-change ledger) |

## 6 · THE FOUR CORE CAPABILITIES
1. **THE HUMAN GATE** — risk-tiered approval inside the run; approvals AND refusals receipted.
2. **SIGNED RECEIPTS** — hash-chained, HMAC-sealed, Ed25519-signed; verifiable offline on a machine that never saw the app.
...
## 9 · AGENTS WORKING TOGETHER (what VH already ships)
...
## 10 · RSIRALS v5.0 — trust-rooted self-improvement
...
---
*Honesty rules of this document: pre-revenue by stage — these are engineering facts, not traction. Where competitors disclose nothing, we write "not disclosed". Founder fields are never invented.*
