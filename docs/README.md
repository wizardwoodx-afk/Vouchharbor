...
`docs/` ships the verification and history for VH. Live documents:
...
- `MOSAIC-OMEGA-COMPAT.md` — compatibility audit of VH against an external
  framework spec; documents the 11.12.0 alignment extract
- `VARKHA-COMPAT.md` — compatibility audit of VH against a second external
...
- `history/VH-14.1.1-WINDOWS-FIX.md` — what the Windows fix + cleanup changed
