# Install Vouch Harbor 18.0.0 on your laptop (Windows 11) — the only supported install
...
1. The header says **Vouch Harbor 18.0.0** (Help → About must agree — `probe/versionDrift` enforces this).
