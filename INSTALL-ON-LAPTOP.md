# Install Vouch Harbor 19.2.0 on your laptop (Windows 11) — the only supported install
...
```
src-tauri\target\release\bundle\nsis\Vouch Harbor 19.2.0_x64-setup.exe
```
...
1. The header says **Vouch Harbor 19.2.0** (Help → About must agree — `probe/versionDrift` enforces this).
