# Install Vouch Harbor 17.10.9 on your laptop (Windows 11) — the only supported install
...
```
src-tauri\target\release\bundle\nsis\Vouch Harbor 17.10.9_x64-setup.exe
```
...
1. The header says **Vouch Harbor 17.10.9** (Help → About must agree — `probe/versionDrift` enforces this).
