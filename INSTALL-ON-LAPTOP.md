# Install Vouch Harbor 19.4.5 on your laptop (Windows 11) — the only supported install
...
1. The header says **Vouch Harbor 19.4.5** (Help → About must agree — `probe/versionDrift` enforces this).
