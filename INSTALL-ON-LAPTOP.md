# Install Vouch Harbor 18.1.0 on your laptop (Windows 11) — the only supported install
...
```
src-tauri\target\release\bundle\nsis\Vouch Harbor 18.1.0_x64-setup.exe
```
...
1. The header says **Vouch Harbor 18.1.0** (Help → About must agree — `probe/versionDrift` enforces this).
