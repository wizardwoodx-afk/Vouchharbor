# Install Vouch Harbor 19.6.6 on your laptop (Windows 11) — the only supported install
...
```
src-tauri\target\release\bundle\nsis\Vouch Harbor 19.6.6_x64-setup.exe
```
...
1. The header says **Vouch Harbor 19.6.6** (Help → About must agree — `probe/versionDrift` enforces this).
