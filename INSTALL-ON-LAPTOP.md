# Install Vouch Harbor 17.6.2 on your laptop (Windows 11) — the only supported install
...
```
src-tauri\target\release\bundle\nsis\Vouch Harbor 17.6.2_x64-setup.exe
```
...
1. The header says **Vouch Harbor 17.6.2** (Help → About must agree — `probe/versionDrift` enforces this).
