# Vouch Harbor 19.7.12 — BUILD NATIVE (Windows 11)
...
| Platform | Output |
|---|---|
| Windows | `src-tauri/target/release/bundle/nsis/Vouch Harbor_19.7.12_x64-setup.exe` |
...
| `tauri build` → NSIS installer | ok — `Vouch Harbor_19.7.12_x64-setup.exe`, installs per-user |
