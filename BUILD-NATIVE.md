# Vouch Harbor 18.9.0 — BUILD NATIVE (Windows 11)
...
| Platform | Output |
|---|---|
| Windows | `src-tauri/target/release/bundle/nsis/Vouch Harbor_18.9.0_x64-setup.exe` |
...
| `tauri build` → NSIS installer | ok — `Vouch Harbor_18.9.0_x64-setup.exe`, installs per-user |
