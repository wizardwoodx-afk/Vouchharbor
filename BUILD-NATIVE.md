# Vouch Harbor 17.6.2 — BUILD NATIVE (Windows 11)
...
| Platform | Output |
|---|---|
| Windows | `src-tauri/target/release/bundle/nsis/Vouch Harbor_17.6.2_x64-setup.exe` |
...
| `tauri build` → NSIS installer | ok — `Vouch Harbor_17.6.2_x64-setup.exe`, installs per-user |
