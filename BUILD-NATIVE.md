# Vouch Harbor 18.7.0 — BUILD NATIVE (Windows 11)
...
| Platform | Output |
|---|---|
| Windows | `src-tauri/target/release/bundle/nsis/Vouch Harbor_18.7.0_x64-setup.exe` |
...
| `tauri build` → NSIS installer | ok — `Vouch Harbor_18.7.0_x64-setup.exe`, installs per-user |
